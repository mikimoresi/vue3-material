...
<script>
	...
	import MdPortal from "@/components/Material/MdPortal/MdPortal";
	import MdOverlay from "@/components/Material/MdOverlay/MdOverlay.vue";
	import MdFocusTrap from "@/components/Material/MdFocusTrap/MdFocusTrap";
